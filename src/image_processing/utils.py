...
def get_interpretation(
    sign: str, interpretation_type: MoonSignInterpretationType
) -> str:
...
def get_moon_phase_caption(
    utcdate: date, longitude: float, latitude: float, timezone_offset: int
) -> str:
    """
...
def get_image_with_astrodata(
    ...
    moon_phase_caption = get_moon_phase_caption(
        date, longitude, latitude, user.timezone_offset
    )
